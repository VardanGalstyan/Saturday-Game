...
function SettingsModal(props) {
  ...
  const onDragEnd = (result) => {
    ...
    if (
      ...
      const draggableTeam = teams.find(
        (team) => team.team_id === source.droppableId
      );
    ...
    if (destination.droppableId !== source.droppableId) {
      ...
      const droppableTeam = teams.find(
        (team) => team.team_id === destination.droppableId
      );
      const newTeamPlayers = [...draggableTeam.players];
  ...
  const handleConfirmation = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_URL}/players/confirm/${game._id}`,
        {
          method: "PUT",
          headers: {
      ...
      {isLoading ? (
        ...
        <>
                ...
                <div className="d-flex">
                  ...
                  {teamsAreSet || teamsAreConfirmed ? (
                    <div className="random-select-button">
                      <span onClick={handleConfirmation}>
                        {!teamsAreConfirmed ? "Confirm Teams" : "Drop Teams"}
                      </span>
                    </div>
                  ) : null}
                </div>
          ...
          <Modal.Footer>
            <div>
              {!teamsAreSet && (
                <Button className="form-button" onClick={handlePlay}>
